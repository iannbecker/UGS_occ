...
inat_raw <- read.csv("observations-660979.csv/observations-660979.csv")  
...
cat("Loading urban green space sites...\n")
...
####################
#   Part 3: Build Detection Matrices for Test Species
####################

cat("Building detection matrices for test species...\n\n")

# Define 3 test species

test_species_list <- c("Great-tailed Grackle", 
                       "Black-bellied Whistling-Duck",
                       "Great Kiskadee")

cat("Building detection matrices for:\n")
...
for (test_species in test_species_list) {
  ...
  saveRDS(metadata, 
          paste0("detection_metadata_", species_filename, ".rds"))
